...
void pid_systematics_calculator_pim_049(
  ...
  samples.push_back({"pim_pid_cuts_049_ppim.root", "ppip", "strategy", kExperimental, kBlue, 21, 1});
  samples.push_back({"pim_pid_cuts_049_pppippim.root", "pppippim", "strategy", kExperimental, kGreen+2, 22, 1});
  samples.push_back({"pim_pid_cuts_049_exp.root", "pip", "strategy", kReference, kYellow+1, 24, 1});
