...
void pid_macro_tcutg_pim_sim() {
  ...
  chain->Draw(drawCmd, "isBest==1 && eVertReco_z>-500 && pim_sim_id==9", "colz");
  ...
  chain->Draw(drawMA, "isBest==1 && eVertReco_z>-500 &&  pim_sim_id==9 && pim_beta>0 && pim_beta<1.5", "colz");
  ...
  if (contours.valid) {
    saveContourResults(
      ...
      widthLabels,
      nWidths,
      "pim_pid_cuts.root",                 // Output filename
      "pim"                                // Particle name
    );
    ...
    if (cCuts) {
      cCuts->SaveAs("pim_pid_cuts_overlay.png");
    }
  }
  // =====================================================
